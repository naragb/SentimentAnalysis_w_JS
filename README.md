...
According to Amazon Web Services, sentiment analysis can be defined as the process of analyzing digital text to determine if the emotional tone of the message is positive, negative, or neutral. As output, the user receives the total score and information about whether the content in the link is positive, negative, or neutral.
